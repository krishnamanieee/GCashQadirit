...
import com.rohasoft.www.gcash.view.adapter.TransactionAdapter;
...
public class TransactionHistoryFragment extends Fragment {List<Settlement> list;
    ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_transation_history, container, false);
        ...
        serverRequest.transactionHistoryBackground(user, new GetSettlementCallBack() {
            @Override
    ...
    private void settlementHistory(Settlement settlement) {
        ...
        try {
            ...
            JSONArray mJsonArray=mJsonObject.getJSONArray("transactionHistory");
            TransactionAdapter mAdapter=new TransactionAdapter(getActivity(),mJsonArray);
